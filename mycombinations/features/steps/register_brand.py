...
def step_impl(context, username):
    ...
    from mycombinations.models import Brand
...
def step_impl(context):
    for row in context.table:
        context.browser.visit(context.get_url('mycombinations:brand_create'))
        if context.browser.url == context.get_url('mycombinations:brand_create'):
...
def step_impl(context, name):
    ...
    context.browser.visit(context.get_url('mycombinations:brand_edit', brand.pk))
    if context.browser.url == context.get_url('mycombinations:brand_edit', brand.pk)\
